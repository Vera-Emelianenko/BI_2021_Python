help_message = '''
This is a program that works with sequences of nucleic acids.
It was created as a homework for python course in Bioinformatics institute 2021.
Commands:
...
If the sequence can be either DNA or RNA (e. g. "AGGGCCCA"), the complement string is generated as DNA
(e. g. "TCCCGGGA" and not "UCCCGGGA")
